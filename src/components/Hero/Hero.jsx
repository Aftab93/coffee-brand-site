                    ...
                    <div className='text-lightOrange mt-[100px] md:mt-0 p-4 space-y-28'>
                        ...
                        className='relative'>
                            <div className='relative z-10 space-y-4'>
                                ...
                                <h1 className='text-sm opacity-55 leading-loose'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus provident est facilis, tempore cum maiores veritatis delectus eveniet dolores quaerat autem vero</h1>
                            </div>
